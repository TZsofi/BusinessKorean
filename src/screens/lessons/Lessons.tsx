...
export interface ILessonsNavigationProps {
  navigation: NavigationScreenProp<NavigationState, NavigationParams>;
}
type lessonsProps = ILessonsNavigationProps;

export default class Lessons extends React.Component<lessonsProps, any> {
